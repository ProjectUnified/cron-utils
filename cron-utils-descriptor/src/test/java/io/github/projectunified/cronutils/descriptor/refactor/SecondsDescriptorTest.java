...
import io.github.projectunified.cronutils.model.field.expression.And;
...
class SecondsDescriptorTest {
	...
	@BeforeEach
	public void setUp() {
		resourceBundle = ResourceBundle.getBundle("io.github.projectunified.cronutils.CronUtilsI18N", Locale.UK);
